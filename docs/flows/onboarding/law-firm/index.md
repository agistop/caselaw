...
9-screen flow covering account type selection through plan selection. Ends when the user has created
an account, configured their firm workspace, accepted terms, and chosen a billing plan.
...
- `onboarding-modal` — in-app dialog overlay; progress-steps header; Go back + Continue footer
...
**New patterns introduced:** `onboarding-modal`, `progress-steps`

---

### Screen 5 — Add Collaborators (empty)

- `onboarding-modal` — progress-steps header; step 2 `active`
...
- `onboarding-modal` — progress-steps header; step 3 `active`; scrollable content body
