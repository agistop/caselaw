...
@Component({
  selector: 'app-st-terms-privacy',
  standalone: true,
  imports: [ModalShell, LegalConsentRow, HlmButton],
  template: `
    <app-modal-shell [totalSteps]="4" [currentStep]="3">
      ...
      <div class="max-h-48 overflow-y-auto rounded-md border border-border p-4 text-xs leading-relaxed text-muted-foreground">
