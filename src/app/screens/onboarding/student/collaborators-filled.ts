...
@Component({
  selector: 'app-st-collaborators-filled',
  standalone: true,
    ...
    <app-modal-shell [totalSteps]="4" [currentStep]="2">
      ...
      <div header>
        ...
        <p class="mt-1 text-sm text-muted-foreground">
          Send invites to the classmates you would like to collaborate with.
        </p>
      </div>
...
export class StCollaboratorsFilled {
  readonly emailTags = [
    'john@college.com', 'jane@college.com', 'lisa@college.com',
    'david@college.com', 'chris@college.com',
  ];
}
