  ...
  template: `
    <app-onboarding-shell>
      ...
      <div class="mx-auto mt-10 max-w-sm space-y-2">
        <label hlmLabel>Select a persona</label>
        <!-- Trigger (open state) -->
        <div class="flex h-9 w-full items-center justify-between rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-xs">
          <span class="text-muted-foreground">Select persona</span>
        ...
        <!-- Dropdown panel -->
        <div class="rounded-md border border-border bg-popover p-1 shadow-md">
          <div class="cursor-default rounded-sm px-3 py-1.5 text-sm text-popover-foreground">Researcher</div>
          <div class="cursor-default rounded-sm px-3 py-1.5 text-sm text-popover-foreground">Sole Lawyer</div>
          <div class="cursor-default rounded-sm bg-accent px-3 py-1.5 text-sm text-accent-foreground">Student</div>
          <div class="cursor-default rounded-sm px-3 py-1.5 text-sm text-popover-foreground">Other</div>
        </div>
      </div>
