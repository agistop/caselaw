...
@Component({
  selector: 'app-lf-create-account',
  standalone: true,
    ...
    <app-onboarding-shell>
      <div class="text-center">
        ...
        <p class="mt-2 text-sm text-muted-foreground">
          Please use your business email as this<br>will verify that you are a law firm.
        </p>
      </div>

      <div class="mx-auto mt-8 max-w-sm space-y-4">
        <div class="space-y-1.5">
          <label hlmLabel>Business email</label>
          <input hlmInput type="email" placeholder="name@lawfirm.com" class="w-full" />
        </div>
