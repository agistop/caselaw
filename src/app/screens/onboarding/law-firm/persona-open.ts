    ...
    <app-onboarding-shell>
      ...
      <div class="mx-auto mt-10 max-w-sm space-y-2">
        ...
        <div class="rounded-md border border-border bg-popover p-1 shadow-md">
          <div class="cursor-default rounded-sm bg-accent px-3 py-1.5 text-sm text-accent-foreground">Law Firm</div>
          <div class="cursor-default rounded-sm px-3 py-1.5 text-sm text-popover-foreground">Company</div>
          <div class="cursor-default rounded-sm px-3 py-1.5 text-sm text-popover-foreground">Student Body</div>
